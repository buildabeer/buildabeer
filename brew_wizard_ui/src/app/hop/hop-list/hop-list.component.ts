...
export class HopListComponent implements OnInit {
  ...
  search: string = "";
  title: string = "Hops";
  selectedHopCountDropdown: string = "All";
  selectedHopTypeDropdown: string = "0";
  selectedHopOriginDropdown: string = "0";
  ...
  deleteEvent(event): void {
    var index = this.hops.indexOf(event.hop);
    if (index > -1) {
